...
| 文档 | 状态 | 说明 |
|------|------|------|
| `docs/RULES.md` | ✅ 完整 | 权威游戏规则 |
| `docs/ARCHITECTURE.md` | ✅ 完整 | 架构设计与演进路线 |
| `docs/BOARD_EDITOR.md` | ✅ 完整 | 棋盘编辑器设计 |
| `docs/OPTIMIZATION.md` | ✅ 完整 | 性能优化分析 |
| `docs/plans/2026-04-23-board-visualization-system.md` | ✅ 已实现 | 棋盘可视化重构计划 |
| `AGENTS.md` | ⚠️ 需要更新 | 开发指南，部分内容过时 |
| `IMPROVEMENTS.md` | ✅ 已更新 | 改进建议与已知问题 |
...
详见 [IMPROVEMENTS.md](IMPROVEMENTS.md)，主要问题：

| ID | 严重度 | 问题 | 文件 |
|----|--------|------|------|
| C1 | 🔴 CRITICAL | 双重消除调用 | `env.py:142-144` |
| C2 | 🔴 CRITICAL | `hex_value` 始终为 0 | `server/game.py:138,155,171` |
| C3 | 🟡 HIGH | `TOTAL_VALUE=100` 应为 99 | `penguinchess/reward.py:14` |
| C4 | 🟡 HIGH | 硬编码自定义棋盘 ID | `frontend/App.tsx:151,166` |
| C5 | 🟡 HIGH | 调试脚本引用已删除 API | 5 个调试文件 |
